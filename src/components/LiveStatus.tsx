...
const VARIANTS = {
  open: {
    dot: 'bg-success',
    label: 'Connected',
    title: 'Receiving live updates from PyMedusa.',
    pulse: false,
  },
  connecting: {
    dot: 'bg-warning',
  ...
  closed: {
    dot: 'bg-error',
    label: 'Offline',
    title: 'Connection dropped — auto-reconnect pending. UI falls back to timer-based refresh.',
    pulse: true,
  },
  idle: {
    dot: 'bg-base-content/30',
    label: 'Idle',
    title: 'No active connection — no auth token, or socket was torn down on logout.',
    pulse: false,
  },
} as const
